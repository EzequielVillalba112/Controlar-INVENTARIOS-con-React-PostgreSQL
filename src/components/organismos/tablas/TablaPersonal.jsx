  ...
  const columns = [
    {
      ...
      cell: (info) => (
        <div data-title="Descripcion" className="ContentCell">
          {mobile === true ? <span>Nombre</span> : null}
    ...
    },
    {
      ...
      cell: (info) => (
        <div data-title="Descripcion" className="ContentCell">
          {mobile === true ? <span>D.N.I</span> : null}
          <span>{info.getValue()}</span>
        </div>
      ),
    },
    {
      ...
      cell: (info) => (
        <div data-title="Descripcion" className="ContentCell">
          {mobile === true ? <span>Telefono</span> : null}
          <span>{info.getValue()}</span>
        </div>
      ),
    },
    {
      ...
      cell: (info) => (
        <div data-title="Descripcion" className="ContentCell">
          {mobile === true ? <span>Estado</span> : null}
          <span>{info.getValue()}</span>
        </div>
      ),
    },
    {
      ...
      cell: (info) => (
        <div data-title="Descripcion" className="ContentCell">
          {mobile === true ? <span>Tipo User.</span> : null}
          <span>{info.getValue()}</span>
        </div>
      ),
    },
    {
      ...
      cell: (info) => (
        <div data-title="Descripcion" className="ContentCell">
          {mobile === true ? <span>Correo</span> : null}
          <span>{info.getValue()}</span>
        </div>
      ),
    },
    {
      ...
      cell: (info) => (
        <div data-title="Descripcion" className="ContentCell">
          {mobile === true ? <span>Dirección</span> : null}
          <span>{info.getValue()}</span>
        </div>
      ),
    },
